...
class AutoCompleteAdapter(context: Context) : ArrayAdapter<String>(context, R.layout.spinner_drop_down_item) {

    private var itemList = ArrayList<LabTestSearchResponse>()
    ...
    fun setData(itemList: ArrayList<LabTestSearchResponse>) {
